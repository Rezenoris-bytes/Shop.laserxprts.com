...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Reach our expert team for laser spares, consumables and technical support.',
    ...
    <main>
      ...
      <section className="bg-ink py-14 text-white">
        <div className="container-lei">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-amber">Get in touch</p>
          <h1 className="mt-3 text-4xl font-black tracking-tight lg:text-5xl">
            We&apos;re here to help.
          </h1>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/65">
            Tell us what you need — part numbers, machine model, quantity — and our team will
      ...
      <section className="bg-white py-14">
        <div className="container-lei text-center">
          ...
          <h2 className="mt-2 text-3xl font-black tracking-tight">Our locations</h2>
